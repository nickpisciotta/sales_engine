...
describe "Find Revenue for a merchant" do
  ...
  it 'finds revenue by date' do
    ...
    invoice_item1 = create(:invoice_item, invoice: invoice1, quantity: 2, unit_price: 10, created_at: time)

    transaction2 = create(:transaction, invoice: invoice2, result: "success", created_at: time2)
    invoice_item1 = create(:invoice_item, invoice: invoice2, quantity: 2, unit_price: 10, created_at: time2)
